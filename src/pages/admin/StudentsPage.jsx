...
import { UserPlus, Search, Eye, Edit, Trash2, X, RotateCw, Check } from 'lucide-react';
...
export default function StudentsPage() {
  ...
  const [form, setForm] = useState({ prenom: '', nom: '', date_naissance: '', adresse: '', parent_nom: '', filiation: '', parent_telephone: '', parent_email: '', infos_importantes: '', classeId: '', annee_scolaire: '' });
      ...
      <div className="admin-panel">
        <div className="table-responsive">
          <table className="admin-table">
            <thead>
              <tr><th></th><th>Matricule</th><th>Nom Complet</th><th>Date de naissance</th><th>Classe</th><th>Statut</th><th>Actions</th></tr>
            </thead>
            <tbody>
              {filtered.length === 0 ? (
